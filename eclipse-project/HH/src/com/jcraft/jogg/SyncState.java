...
/*     */       }
/*     */ 
/* 116 */       if ((this.data[page] != 79) || (this.data[(page + 1)] != 103) || (this.data[(page + 2)] != 103) || 
/* 117 */         (this.data[(page + 3)] != 83)) {
...
/* 170 */       log.checksum();
/*     */ 
/* 173 */       if ((this.chksum[0] != this.data[(page + 22)]) || (this.chksum[1] != this.data[(page + 23)]) || 
/* 174 */         (this.chksum[2] != this.data[(page + 24)]) || (this.chksum[3] != this.data[(page + 25)]))
/*     */       {
