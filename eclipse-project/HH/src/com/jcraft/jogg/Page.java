...
/*     */ 
/*     */   public int serialno() {
/*  89 */     return this.header_base[(this.header + 14)] & 0xFF | (this.header_base[(this.header + 15)] & 0xFF) << 8 | 
/*  90 */       (this.header_base[(this.header + 16)] & 0xFF) << 16 | 
/*  91 */       (this.header_base[(this.header + 17)] & 0xFF) << 24;
/*     */   }
/*     */ 
/*     */   int pageno() {
/*  95 */     return this.header_base[(this.header + 18)] & 0xFF | (this.header_base[(this.header + 19)] & 0xFF) << 8 | 
/*  96 */       (this.header_base[(this.header + 20)] & 0xFF) << 16 | 
/*  97 */       (this.header_base[(this.header + 21)] & 0xFF) << 24;
/*     */   }
/*     */ 
/*     */   void checksum() {
/* 101 */     int crc_reg = 0;
...
/* 104 */       crc_reg = crc_reg << 8 ^ 
/* 105 */         crc_lookup[(crc_reg >>> 24 & 0xFF ^ this.header_base[(this.header + i)] & 0xFF)];
/*     */     }
/* 107 */     for (int i = 0; i < this.body_len; i++) {
/* 108 */       crc_reg = crc_reg << 8 ^ 
/* 109 */         crc_lookup[(crc_reg >>> 24 & 0xFF ^ this.body_base[(this.body + i)] & 0xFF)];
/*     */     }
