...
/*     */ 
/* 207 */     while (size == 255) {
/* 208 */       ptr++; int val = this.lacing_vals[ptr];
/* 209 */       size = val & 0xFF;
/* 210 */       if ((val & 0x200) != 0)
/* 211 */         op.e_o_s = 512;
/* 212 */       bytes += size;
...
/*     */     else
/*     */     {
/* 399 */       for (vals = 0; vals < maxvals; vals++) {
/* 400 */         if (acc > 4096)
/*     */           break;
...
/*     */     {
/*     */       int tmp189_188 = 5;
/*     */       byte[] tmp189_185 = this.header; tmp189_185[tmp189_188] = (byte)(tmp189_185[tmp189_188] | 0x1);
/*     */     }
/* 418 */     if (this.b_o_s == 0)
/*     */     {
/*     */       int tmp207_206 = 5;
/*     */       byte[] tmp207_203 = this.header; tmp207_203[tmp207_206] = (byte)(tmp207_203[tmp207_206] | 0x2);
/*     */     }
/* 421 */     if ((this.e_o_s != 0) && (this.lacing_fill == vals))
/*     */     {
/*     */       int tmp233_232 = 5;
/*     */       byte[] tmp233_229 = this.header; tmp233_229[tmp233_232] = (byte)(tmp233_229[tmp233_232] | 0x4);
/* 423 */     }this.b_o_s = 1;
/*     */ 		int i = 6;
/* 426 */     for (i = 6; i < 14; i++) {
...
/*     */   {
/* 496 */     if (((this.e_o_s != 0) && (this.lacing_fill != 0)) || 
/* 497 */       (this.body_fill - this.body_returned > 4096) || 
/* 498 */       (this.lacing_fill >= 255) || (
/* 499 */       (this.lacing_fill != 0) && (this.b_o_s == 0))) {
/* 500 */       return flush(og);
/*     */     }
/* 502 */     return 0;
/*     */   }
